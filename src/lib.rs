...
pub const MBEDTLS_SSL_CBC_RECORD_SPLITTING_DISABLED: c_char = 0;
pub const MBEDTLS_SSL_CBC_RECORD_SPLITTING_ENABLED: c_char = 1;
pub const MBEDTLS_SSL_ARC4_ENABLED: c_char = 0;
pub const MBEDTLS_SSL_ARC4_DISABLED: c_char = 1;
