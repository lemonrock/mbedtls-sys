...
pub const MBEDTLS_ERR_MPI_FILE_IO_ERROR: c_char = -2;
pub const MBEDTLS_ERR_MPI_BAD_INPUT_DATA: c_char = -4;
pub const MBEDTLS_ERR_MPI_INVALID_CHARACTER: c_char = -6;
pub const MBEDTLS_ERR_MPI_BUFFER_TOO_SMALL: c_char = -8;
pub const MBEDTLS_ERR_MPI_NEGATIVE_VALUE: c_char = -10;
pub const MBEDTLS_ERR_MPI_DIVISION_BY_ZERO: c_char = -12;
pub const MBEDTLS_ERR_MPI_NOT_ACCEPTABLE: c_char = -14;
pub const MBEDTLS_ERR_MPI_ALLOC_FAILED: c_char = -16;
pub const MBEDTLS_MPI_MAX_LIMBS: c_ushort = 10000;
pub const MBEDTLS_MPI_WINDOW_SIZE: c_uchar = 6;
pub const MBEDTLS_MPI_MAX_SIZE: c_ushort = 1024;
pub const MBEDTLS_MPI_MAX_BITS: c_ushort = 8192;
pub const MBEDTLS_MPI_MAX_BITS_SCALE100: c_uint = 819200;
pub const MBEDTLS_LN_2_DIV_LN_10_SCALE100: c_ushort = 332;
pub const MBEDTLS_MPI_RW_BUFFER_SIZE: c_ushort = 2484;
pub const MBEDTLS_ERR_ECP_BAD_INPUT_DATA: c_short = -20352;
pub const MBEDTLS_ERR_ECP_BUFFER_TOO_SMALL: c_short = -20224;
pub const MBEDTLS_ERR_ECP_FEATURE_UNAVAILABLE: c_short = -20096;
pub const MBEDTLS_ERR_ECP_VERIFY_FAILED: c_short = -19968;
pub const MBEDTLS_ERR_ECP_ALLOC_FAILED: c_short = -19840;
pub const MBEDTLS_ERR_ECP_RANDOM_FAILED: c_short = -19712;
pub const MBEDTLS_ERR_ECP_INVALID_KEY: c_short = -19584;
pub const MBEDTLS_ERR_ECP_SIG_LEN_MISMATCH: c_short = -19456;
pub const MBEDTLS_ECP_DP_MAX: c_uchar = 12;
pub const MBEDTLS_ECP_MAX_BITS: c_ushort = 521;
pub const MBEDTLS_ECP_MAX_BYTES: c_uchar = 66;
pub const MBEDTLS_ECP_MAX_PT_LEN: c_uchar = 133;
pub const MBEDTLS_ECP_WINDOW_SIZE: c_uchar = 6;
pub const MBEDTLS_ECP_FIXED_POINT_OPTIM: c_uchar = 1;
pub const MBEDTLS_ECP_PF_UNCOMPRESSED: c_uchar = 0;
pub const MBEDTLS_ECP_PF_COMPRESSED: c_uchar = 1;
pub const MBEDTLS_ECP_TLS_NAMED_CURVE: c_uchar = 3;
pub const MBEDTLS_ERR_MD_FEATURE_UNAVAILABLE: c_short = -20608;
pub const MBEDTLS_ERR_MD_BAD_INPUT_DATA: c_short = -20736;
pub const MBEDTLS_ERR_MD_ALLOC_FAILED: c_short = -20864;
pub const MBEDTLS_ERR_MD_FILE_IO_ERROR: c_short = -20992;
pub const MBEDTLS_MD_MAX_SIZE: c_uchar = 64;
pub const MBEDTLS_ERR_THREADING_FEATURE_UNAVAILABLE: c_char = -26;
pub const MBEDTLS_ERR_THREADING_BAD_INPUT_DATA: c_char = -28;
pub const MBEDTLS_ERR_THREADING_MUTEX_ERROR: c_char = -30;
pub const MBEDTLS_ERR_RSA_BAD_INPUT_DATA: c_short = -16512;
pub const MBEDTLS_ERR_RSA_INVALID_PADDING: c_short = -16640;
pub const MBEDTLS_ERR_RSA_KEY_GEN_FAILED: c_short = -16768;
pub const MBEDTLS_ERR_RSA_KEY_CHECK_FAILED: c_short = -16896;
pub const MBEDTLS_ERR_RSA_PUBLIC_FAILED: c_short = -17024;
pub const MBEDTLS_ERR_RSA_PRIVATE_FAILED: c_short = -17152;
pub const MBEDTLS_ERR_RSA_VERIFY_FAILED: c_short = -17280;
pub const MBEDTLS_ERR_RSA_OUTPUT_TOO_LARGE: c_short = -17408;
pub const MBEDTLS_ERR_RSA_RNG_FAILED: c_short = -17536;
pub const MBEDTLS_RSA_PUBLIC: c_uchar = 0;
pub const MBEDTLS_RSA_PRIVATE: c_uchar = 1;
pub const MBEDTLS_RSA_PKCS_V15: c_uchar = 0;
pub const MBEDTLS_RSA_PKCS_V21: c_uchar = 1;
pub const MBEDTLS_RSA_SIGN: c_uchar = 1;
pub const MBEDTLS_RSA_CRYPT: c_uchar = 2;
pub const MBEDTLS_RSA_SALT_LEN_ANY: c_char = -1;
pub const MBEDTLS_ECDSA_MAX_LEN: c_uchar = 141;
pub const MBEDTLS_ERR_PK_ALLOC_FAILED: c_short = -16256;
pub const MBEDTLS_ERR_PK_TYPE_MISMATCH: c_short = -16128;
pub const MBEDTLS_ERR_PK_BAD_INPUT_DATA: c_short = -16000;
pub const MBEDTLS_ERR_PK_FILE_IO_ERROR: c_short = -15872;
pub const MBEDTLS_ERR_PK_KEY_INVALID_VERSION: c_short = -15744;
pub const MBEDTLS_ERR_PK_KEY_INVALID_FORMAT: c_short = -15616;
pub const MBEDTLS_ERR_PK_UNKNOWN_PK_ALG: c_short = -15488;
pub const MBEDTLS_ERR_PK_PASSWORD_REQUIRED: c_short = -15360;
pub const MBEDTLS_ERR_PK_PASSWORD_MISMATCH: c_short = -15232;
pub const MBEDTLS_ERR_PK_INVALID_PUBKEY: c_short = -15104;
pub const MBEDTLS_ERR_PK_INVALID_ALG: c_short = -14976;
pub const MBEDTLS_ERR_PK_UNKNOWN_NAMED_CURVE: c_short = -14848;
pub const MBEDTLS_ERR_PK_FEATURE_UNAVAILABLE: c_short = -14720;
pub const MBEDTLS_ERR_PK_SIG_LEN_MISMATCH: c_short = -14592;
pub const MBEDTLS_PK_DEBUG_MAX_ITEMS: c_uchar = 3;
pub const MBEDTLS_ERR_CIPHER_FEATURE_UNAVAILABLE: c_short = -24704;
pub const MBEDTLS_ERR_CIPHER_BAD_INPUT_DATA: c_short = -24832;
pub const MBEDTLS_ERR_CIPHER_ALLOC_FAILED: c_short = -24960;
pub const MBEDTLS_ERR_CIPHER_INVALID_PADDING: c_short = -25088;
pub const MBEDTLS_ERR_CIPHER_FULL_BLOCK_EXPECTED: c_short = -25216;
pub const MBEDTLS_ERR_CIPHER_AUTH_FAILED: c_short = -25344;
pub const MBEDTLS_ERR_CIPHER_INVALID_CONTEXT: c_short = -25472;
pub const MBEDTLS_CIPHER_VARIABLE_IV_LEN: c_uchar = 1;
pub const MBEDTLS_CIPHER_VARIABLE_KEY_LEN: c_uchar = 2;
pub const MBEDTLS_MAX_IV_LENGTH: c_uchar = 16;
pub const MBEDTLS_MAX_BLOCK_LENGTH: c_uchar = 16;
pub const MBEDTLS_TLS_RSA_WITH_NULL_MD5: c_uchar = 1;
pub const MBEDTLS_TLS_RSA_WITH_NULL_SHA: c_uchar = 2;
pub const MBEDTLS_TLS_RSA_WITH_RC4_128_MD5: c_uchar = 4;
pub const MBEDTLS_TLS_RSA_WITH_RC4_128_SHA: c_uchar = 5;
pub const MBEDTLS_TLS_RSA_WITH_DES_CBC_SHA: c_uchar = 9;
pub const MBEDTLS_TLS_RSA_WITH_3DES_EDE_CBC_SHA: c_uchar = 10;
pub const MBEDTLS_TLS_DHE_RSA_WITH_DES_CBC_SHA: c_uchar = 21;
pub const MBEDTLS_TLS_DHE_RSA_WITH_3DES_EDE_CBC_SHA: c_uchar = 22;
pub const MBEDTLS_TLS_PSK_WITH_NULL_SHA: c_uchar = 44;
pub const MBEDTLS_TLS_DHE_PSK_WITH_NULL_SHA: c_uchar = 45;
pub const MBEDTLS_TLS_RSA_PSK_WITH_NULL_SHA: c_uchar = 46;
pub const MBEDTLS_TLS_RSA_WITH_AES_128_CBC_SHA: c_uchar = 47;
pub const MBEDTLS_TLS_DHE_RSA_WITH_AES_128_CBC_SHA: c_uchar = 51;
pub const MBEDTLS_TLS_RSA_WITH_AES_256_CBC_SHA: c_uchar = 53;
pub const MBEDTLS_TLS_DHE_RSA_WITH_AES_256_CBC_SHA: c_uchar = 57;
pub const MBEDTLS_TLS_RSA_WITH_NULL_SHA256: c_uchar = 59;
pub const MBEDTLS_TLS_RSA_WITH_AES_128_CBC_SHA256: c_uchar = 60;
pub const MBEDTLS_TLS_RSA_WITH_AES_256_CBC_SHA256: c_uchar = 61;
pub const MBEDTLS_TLS_RSA_WITH_CAMELLIA_128_CBC_SHA: c_uchar = 65;
pub const MBEDTLS_TLS_DHE_RSA_WITH_CAMELLIA_128_CBC_SHA: c_uchar = 69;
pub const MBEDTLS_TLS_DHE_RSA_WITH_AES_128_CBC_SHA256: c_uchar = 103;
pub const MBEDTLS_TLS_DHE_RSA_WITH_AES_256_CBC_SHA256: c_uchar = 107;
pub const MBEDTLS_TLS_RSA_WITH_CAMELLIA_256_CBC_SHA: c_uchar = 132;
pub const MBEDTLS_TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA: c_uchar = 136;
pub const MBEDTLS_TLS_PSK_WITH_RC4_128_SHA: c_uchar = 138;
pub const MBEDTLS_TLS_PSK_WITH_3DES_EDE_CBC_SHA: c_uchar = 139;
pub const MBEDTLS_TLS_PSK_WITH_AES_128_CBC_SHA: c_uchar = 140;
pub const MBEDTLS_TLS_PSK_WITH_AES_256_CBC_SHA: c_uchar = 141;
pub const MBEDTLS_TLS_DHE_PSK_WITH_RC4_128_SHA: c_uchar = 142;
pub const MBEDTLS_TLS_DHE_PSK_WITH_3DES_EDE_CBC_SHA: c_uchar = 143;
pub const MBEDTLS_TLS_DHE_PSK_WITH_AES_128_CBC_SHA: c_uchar = 144;
pub const MBEDTLS_TLS_DHE_PSK_WITH_AES_256_CBC_SHA: c_uchar = 145;
pub const MBEDTLS_TLS_RSA_PSK_WITH_RC4_128_SHA: c_uchar = 146;
pub const MBEDTLS_TLS_RSA_PSK_WITH_3DES_EDE_CBC_SHA: c_uchar = 147;
pub const MBEDTLS_TLS_RSA_PSK_WITH_AES_128_CBC_SHA: c_uchar = 148;
pub const MBEDTLS_TLS_RSA_PSK_WITH_AES_256_CBC_SHA: c_uchar = 149;
pub const MBEDTLS_TLS_RSA_WITH_AES_128_GCM_SHA256: c_uchar = 156;
pub const MBEDTLS_TLS_RSA_WITH_AES_256_GCM_SHA384: c_uchar = 157;
pub const MBEDTLS_TLS_DHE_RSA_WITH_AES_128_GCM_SHA256: c_uchar = 158;
pub const MBEDTLS_TLS_DHE_RSA_WITH_AES_256_GCM_SHA384: c_uchar = 159;
pub const MBEDTLS_TLS_PSK_WITH_AES_128_GCM_SHA256: c_uchar = 168;
pub const MBEDTLS_TLS_PSK_WITH_AES_256_GCM_SHA384: c_uchar = 169;
pub const MBEDTLS_TLS_DHE_PSK_WITH_AES_128_GCM_SHA256: c_uchar = 170;
pub const MBEDTLS_TLS_DHE_PSK_WITH_AES_256_GCM_SHA384: c_uchar = 171;
pub const MBEDTLS_TLS_RSA_PSK_WITH_AES_128_GCM_SHA256: c_uchar = 172;
pub const MBEDTLS_TLS_RSA_PSK_WITH_AES_256_GCM_SHA384: c_uchar = 173;
pub const MBEDTLS_TLS_PSK_WITH_AES_128_CBC_SHA256: c_uchar = 174;
pub const MBEDTLS_TLS_PSK_WITH_AES_256_CBC_SHA384: c_uchar = 175;
pub const MBEDTLS_TLS_PSK_WITH_NULL_SHA256: c_uchar = 176;
pub const MBEDTLS_TLS_PSK_WITH_NULL_SHA384: c_uchar = 177;
pub const MBEDTLS_TLS_DHE_PSK_WITH_AES_128_CBC_SHA256: c_uchar = 178;
pub const MBEDTLS_TLS_DHE_PSK_WITH_AES_256_CBC_SHA384: c_uchar = 179;
pub const MBEDTLS_TLS_DHE_PSK_WITH_NULL_SHA256: c_uchar = 180;
pub const MBEDTLS_TLS_DHE_PSK_WITH_NULL_SHA384: c_uchar = 181;
pub const MBEDTLS_TLS_RSA_PSK_WITH_AES_128_CBC_SHA256: c_uchar = 182;
pub const MBEDTLS_TLS_RSA_PSK_WITH_AES_256_CBC_SHA384: c_uchar = 183;
pub const MBEDTLS_TLS_RSA_PSK_WITH_NULL_SHA256: c_uchar = 184;
pub const MBEDTLS_TLS_RSA_PSK_WITH_NULL_SHA384: c_uchar = 185;
pub const MBEDTLS_TLS_RSA_WITH_CAMELLIA_128_CBC_SHA256: c_uchar = 186;
pub const MBEDTLS_TLS_DHE_RSA_WITH_CAMELLIA_128_CBC_SHA256: c_uchar = 190;
pub const MBEDTLS_TLS_RSA_WITH_CAMELLIA_256_CBC_SHA256: c_uchar = 192;
pub const MBEDTLS_TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA256: c_uchar = 196;
pub const MBEDTLS_TLS_ECDH_ECDSA_WITH_NULL_SHA: c_ushort = 49153;
pub const MBEDTLS_TLS_ECDH_ECDSA_WITH_RC4_128_SHA: c_ushort = 49154;
pub const MBEDTLS_TLS_ECDH_ECDSA_WITH_3DES_EDE_CBC_SHA: c_ushort = 49155;
pub const MBEDTLS_TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA: c_ushort = 49156;
pub const MBEDTLS_TLS_ECDH_ECDSA_WITH_AES_256_CBC_SHA: c_ushort = 49157;
pub const MBEDTLS_TLS_ECDHE_ECDSA_WITH_NULL_SHA: c_ushort = 49158;
pub const MBEDTLS_TLS_ECDHE_ECDSA_WITH_RC4_128_SHA: c_ushort = 49159;
pub const MBEDTLS_TLS_ECDHE_ECDSA_WITH_3DES_EDE_CBC_SHA: c_ushort = 49160;
pub const MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA: c_ushort = 49161;
pub const MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA: c_ushort = 49162;
pub const MBEDTLS_TLS_ECDH_RSA_WITH_NULL_SHA: c_ushort = 49163;
pub const MBEDTLS_TLS_ECDH_RSA_WITH_RC4_128_SHA: c_ushort = 49164;
pub const MBEDTLS_TLS_ECDH_RSA_WITH_3DES_EDE_CBC_SHA: c_ushort = 49165;
pub const MBEDTLS_TLS_ECDH_RSA_WITH_AES_128_CBC_SHA: c_ushort = 49166;
pub const MBEDTLS_TLS_ECDH_RSA_WITH_AES_256_CBC_SHA: c_ushort = 49167;
pub const MBEDTLS_TLS_ECDHE_RSA_WITH_NULL_SHA: c_ushort = 49168;
pub const MBEDTLS_TLS_ECDHE_RSA_WITH_RC4_128_SHA: c_ushort = 49169;
pub const MBEDTLS_TLS_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA: c_ushort = 49170;
pub const MBEDTLS_TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA: c_ushort = 49171;
pub const MBEDTLS_TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA: c_ushort = 49172;
pub const MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256: c_ushort = 49187;
pub const MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384: c_ushort = 49188;
pub const MBEDTLS_TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA256: c_ushort = 49189;
pub const MBEDTLS_TLS_ECDH_ECDSA_WITH_AES_256_CBC_SHA384: c_ushort = 49190;
pub const MBEDTLS_TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256: c_ushort = 49191;
pub const MBEDTLS_TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384: c_ushort = 49192;
pub const MBEDTLS_TLS_ECDH_RSA_WITH_AES_128_CBC_SHA256: c_ushort = 49193;
pub const MBEDTLS_TLS_ECDH_RSA_WITH_AES_256_CBC_SHA384: c_ushort = 49194;
pub const MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256: c_ushort = 49195;
pub const MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384: c_ushort = 49196;
pub const MBEDTLS_TLS_ECDH_ECDSA_WITH_AES_128_GCM_SHA256: c_ushort = 49197;
pub const MBEDTLS_TLS_ECDH_ECDSA_WITH_AES_256_GCM_SHA384: c_ushort = 49198;
pub const MBEDTLS_TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256: c_ushort = 49199;
pub const MBEDTLS_TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384: c_ushort = 49200;
pub const MBEDTLS_TLS_ECDH_RSA_WITH_AES_128_GCM_SHA256: c_ushort = 49201;
pub const MBEDTLS_TLS_ECDH_RSA_WITH_AES_256_GCM_SHA384: c_ushort = 49202;
pub const MBEDTLS_TLS_ECDHE_PSK_WITH_RC4_128_SHA: c_ushort = 49203;
pub const MBEDTLS_TLS_ECDHE_PSK_WITH_3DES_EDE_CBC_SHA: c_ushort = 49204;
pub const MBEDTLS_TLS_ECDHE_PSK_WITH_AES_128_CBC_SHA: c_ushort = 49205;
pub const MBEDTLS_TLS_ECDHE_PSK_WITH_AES_256_CBC_SHA: c_ushort = 49206;
pub const MBEDTLS_TLS_ECDHE_PSK_WITH_AES_128_CBC_SHA256: c_ushort = 49207;
pub const MBEDTLS_TLS_ECDHE_PSK_WITH_AES_256_CBC_SHA384: c_ushort = 49208;
pub const MBEDTLS_TLS_ECDHE_PSK_WITH_NULL_SHA: c_ushort = 49209;
pub const MBEDTLS_TLS_ECDHE_PSK_WITH_NULL_SHA256: c_ushort = 49210;
pub const MBEDTLS_TLS_ECDHE_PSK_WITH_NULL_SHA384: c_ushort = 49211;
pub const MBEDTLS_TLS_ECDHE_ECDSA_WITH_CAMELLIA_128_CBC_SHA256: c_ushort = 49266;
pub const MBEDTLS_TLS_ECDHE_ECDSA_WITH_CAMELLIA_256_CBC_SHA384: c_ushort = 49267;
pub const MBEDTLS_TLS_ECDH_ECDSA_WITH_CAMELLIA_128_CBC_SHA256: c_ushort = 49268;
pub const MBEDTLS_TLS_ECDH_ECDSA_WITH_CAMELLIA_256_CBC_SHA384: c_ushort = 49269;
pub const MBEDTLS_TLS_ECDHE_RSA_WITH_CAMELLIA_128_CBC_SHA256: c_ushort = 49270;
pub const MBEDTLS_TLS_ECDHE_RSA_WITH_CAMELLIA_256_CBC_SHA384: c_ushort = 49271;
pub const MBEDTLS_TLS_ECDH_RSA_WITH_CAMELLIA_128_CBC_SHA256: c_ushort = 49272;
pub const MBEDTLS_TLS_ECDH_RSA_WITH_CAMELLIA_256_CBC_SHA384: c_ushort = 49273;
pub const MBEDTLS_TLS_RSA_WITH_CAMELLIA_128_GCM_SHA256: c_ushort = 49274;
pub const MBEDTLS_TLS_RSA_WITH_CAMELLIA_256_GCM_SHA384: c_ushort = 49275;
pub const MBEDTLS_TLS_DHE_RSA_WITH_CAMELLIA_128_GCM_SHA256: c_ushort = 49276;
pub const MBEDTLS_TLS_DHE_RSA_WITH_CAMELLIA_256_GCM_SHA384: c_ushort = 49277;
pub const MBEDTLS_TLS_ECDHE_ECDSA_WITH_CAMELLIA_128_GCM_SHA256: c_ushort = 49286;
pub const MBEDTLS_TLS_ECDHE_ECDSA_WITH_CAMELLIA_256_GCM_SHA384: c_ushort = 49287;
pub const MBEDTLS_TLS_ECDH_ECDSA_WITH_CAMELLIA_128_GCM_SHA256: c_ushort = 49288;
pub const MBEDTLS_TLS_ECDH_ECDSA_WITH_CAMELLIA_256_GCM_SHA384: c_ushort = 49289;
pub const MBEDTLS_TLS_ECDHE_RSA_WITH_CAMELLIA_128_GCM_SHA256: c_ushort = 49290;
pub const MBEDTLS_TLS_ECDHE_RSA_WITH_CAMELLIA_256_GCM_SHA384: c_ushort = 49291;
pub const MBEDTLS_TLS_ECDH_RSA_WITH_CAMELLIA_128_GCM_SHA256: c_ushort = 49292;
pub const MBEDTLS_TLS_ECDH_RSA_WITH_CAMELLIA_256_GCM_SHA384: c_ushort = 49293;
pub const MBEDTLS_TLS_PSK_WITH_CAMELLIA_128_GCM_SHA256: c_ushort = 49294;
pub const MBEDTLS_TLS_PSK_WITH_CAMELLIA_256_GCM_SHA384: c_ushort = 49295;
pub const MBEDTLS_TLS_DHE_PSK_WITH_CAMELLIA_128_GCM_SHA256: c_ushort = 49296;
pub const MBEDTLS_TLS_DHE_PSK_WITH_CAMELLIA_256_GCM_SHA384: c_ushort = 49297;
pub const MBEDTLS_TLS_RSA_PSK_WITH_CAMELLIA_128_GCM_SHA256: c_ushort = 49298;
pub const MBEDTLS_TLS_RSA_PSK_WITH_CAMELLIA_256_GCM_SHA384: c_ushort = 49299;
pub const MBEDTLS_TLS_PSK_WITH_CAMELLIA_128_CBC_SHA256: c_ushort = 49300;
pub const MBEDTLS_TLS_PSK_WITH_CAMELLIA_256_CBC_SHA384: c_ushort = 49301;
pub const MBEDTLS_TLS_DHE_PSK_WITH_CAMELLIA_128_CBC_SHA256: c_ushort = 49302;
pub const MBEDTLS_TLS_DHE_PSK_WITH_CAMELLIA_256_CBC_SHA384: c_ushort = 49303;
pub const MBEDTLS_TLS_RSA_PSK_WITH_CAMELLIA_128_CBC_SHA256: c_ushort = 49304;
pub const MBEDTLS_TLS_RSA_PSK_WITH_CAMELLIA_256_CBC_SHA384: c_ushort = 49305;
pub const MBEDTLS_TLS_ECDHE_PSK_WITH_CAMELLIA_128_CBC_SHA256: c_ushort = 49306;
pub const MBEDTLS_TLS_ECDHE_PSK_WITH_CAMELLIA_256_CBC_SHA384: c_ushort = 49307;
pub const MBEDTLS_TLS_RSA_WITH_AES_128_CCM: c_ushort = 49308;
pub const MBEDTLS_TLS_RSA_WITH_AES_256_CCM: c_ushort = 49309;
pub const MBEDTLS_TLS_DHE_RSA_WITH_AES_128_CCM: c_ushort = 49310;
pub const MBEDTLS_TLS_DHE_RSA_WITH_AES_256_CCM: c_ushort = 49311;
pub const MBEDTLS_TLS_RSA_WITH_AES_128_CCM_8: c_ushort = 49312;
pub const MBEDTLS_TLS_RSA_WITH_AES_256_CCM_8: c_ushort = 49313;
pub const MBEDTLS_TLS_DHE_RSA_WITH_AES_128_CCM_8: c_ushort = 49314;
pub const MBEDTLS_TLS_DHE_RSA_WITH_AES_256_CCM_8: c_ushort = 49315;
pub const MBEDTLS_TLS_PSK_WITH_AES_128_CCM: c_ushort = 49316;
pub const MBEDTLS_TLS_PSK_WITH_AES_256_CCM: c_ushort = 49317;
pub const MBEDTLS_TLS_DHE_PSK_WITH_AES_128_CCM: c_ushort = 49318;
pub const MBEDTLS_TLS_DHE_PSK_WITH_AES_256_CCM: c_ushort = 49319;
pub const MBEDTLS_TLS_PSK_WITH_AES_128_CCM_8: c_ushort = 49320;
pub const MBEDTLS_TLS_PSK_WITH_AES_256_CCM_8: c_ushort = 49321;
pub const MBEDTLS_TLS_DHE_PSK_WITH_AES_128_CCM_8: c_ushort = 49322;
pub const MBEDTLS_TLS_DHE_PSK_WITH_AES_256_CCM_8: c_ushort = 49323;
pub const MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_128_CCM: c_ushort = 49324;
pub const MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_256_CCM: c_ushort = 49325;
pub const MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_128_CCM_8: c_ushort = 49326;
pub const MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_256_CCM_8: c_ushort = 49327;
pub const MBEDTLS_TLS_ECJPAKE_WITH_AES_128_CCM_8: c_ushort = 49407;
pub const MBEDTLS_CIPHERSUITE_WEAK: c_uchar = 1;
pub const MBEDTLS_CIPHERSUITE_SHORT_TAG: c_uchar = 2;
pub const MBEDTLS_CIPHERSUITE_NODTLS: c_uchar = 4;
pub const MBEDTLS_ERR_ASN1_OUT_OF_DATA: c_char = -96;
pub const MBEDTLS_ERR_ASN1_UNEXPECTED_TAG: c_char = -98;
pub const MBEDTLS_ERR_ASN1_INVALID_LENGTH: c_char = -100;
pub const MBEDTLS_ERR_ASN1_LENGTH_MISMATCH: c_char = -102;
pub const MBEDTLS_ERR_ASN1_INVALID_DATA: c_char = -104;
pub const MBEDTLS_ERR_ASN1_ALLOC_FAILED: c_char = -106;
pub const MBEDTLS_ERR_ASN1_BUF_TOO_SMALL: c_char = -108;
pub const MBEDTLS_ASN1_BOOLEAN: c_uchar = 1;
pub const MBEDTLS_ASN1_INTEGER: c_uchar = 2;
pub const MBEDTLS_ASN1_BIT_STRING: c_uchar = 3;
pub const MBEDTLS_ASN1_OCTET_STRING: c_uchar = 4;
pub const MBEDTLS_ASN1_NULL: c_uchar = 5;
pub const MBEDTLS_ASN1_OID: c_uchar = 6;
pub const MBEDTLS_ASN1_UTF8_STRING: c_uchar = 12;
pub const MBEDTLS_ASN1_SEQUENCE: c_uchar = 16;
pub const MBEDTLS_ASN1_SET: c_uchar = 17;
pub const MBEDTLS_ASN1_PRINTABLE_STRING: c_uchar = 19;
pub const MBEDTLS_ASN1_T61_STRING: c_uchar = 20;
pub const MBEDTLS_ASN1_IA5_STRING: c_uchar = 22;
pub const MBEDTLS_ASN1_UTC_TIME: c_uchar = 23;
pub const MBEDTLS_ASN1_GENERALIZED_TIME: c_uchar = 24;
pub const MBEDTLS_ASN1_UNIVERSAL_STRING: c_uchar = 28;
pub const MBEDTLS_ASN1_BMP_STRING: c_uchar = 30;
pub const MBEDTLS_ASN1_PRIMITIVE: c_uchar = 0;
pub const MBEDTLS_ASN1_CONSTRUCTED: c_uchar = 32;
pub const MBEDTLS_ASN1_CONTEXT_SPECIFIC: c_uchar = 128;
pub const MBEDTLS_X509_MAX_INTERMEDIATE_CA: c_uchar = 8;
pub const MBEDTLS_ERR_X509_FEATURE_UNAVAILABLE: c_short = -8320;
pub const MBEDTLS_ERR_X509_UNKNOWN_OID: c_short = -8448;
pub const MBEDTLS_ERR_X509_INVALID_FORMAT: c_short = -8576;
pub const MBEDTLS_ERR_X509_INVALID_VERSION: c_short = -8704;
pub const MBEDTLS_ERR_X509_INVALID_SERIAL: c_short = -8832;
pub const MBEDTLS_ERR_X509_INVALID_ALG: c_short = -8960;
pub const MBEDTLS_ERR_X509_INVALID_NAME: c_short = -9088;
pub const MBEDTLS_ERR_X509_INVALID_DATE: c_short = -9216;
pub const MBEDTLS_ERR_X509_INVALID_SIGNATURE: c_short = -9344;
pub const MBEDTLS_ERR_X509_INVALID_EXTENSIONS: c_short = -9472;
pub const MBEDTLS_ERR_X509_UNKNOWN_VERSION: c_short = -9600;
pub const MBEDTLS_ERR_X509_UNKNOWN_SIG_ALG: c_short = -9728;
pub const MBEDTLS_ERR_X509_SIG_MISMATCH: c_short = -9856;
pub const MBEDTLS_ERR_X509_CERT_VERIFY_FAILED: c_short = -9984;
pub const MBEDTLS_ERR_X509_CERT_UNKNOWN_FORMAT: c_short = -10112;
pub const MBEDTLS_ERR_X509_BAD_INPUT_DATA: c_short = -10240;
pub const MBEDTLS_ERR_X509_ALLOC_FAILED: c_short = -10368;
pub const MBEDTLS_ERR_X509_FILE_IO_ERROR: c_short = -10496;
pub const MBEDTLS_ERR_X509_BUFFER_TOO_SMALL: c_short = -10624;
pub const MBEDTLS_X509_BADCERT_EXPIRED: c_uchar = 1;
pub const MBEDTLS_X509_BADCERT_REVOKED: c_uchar = 2;
pub const MBEDTLS_X509_BADCERT_CN_MISMATCH: c_uchar = 4;
pub const MBEDTLS_X509_BADCERT_NOT_TRUSTED: c_uchar = 8;
pub const MBEDTLS_X509_BADCRL_NOT_TRUSTED: c_uchar = 16;
pub const MBEDTLS_X509_BADCRL_EXPIRED: c_uchar = 32;
pub const MBEDTLS_X509_BADCERT_MISSING: c_uchar = 64;
pub const MBEDTLS_X509_BADCERT_SKIP_VERIFY: c_uchar = 128;
pub const MBEDTLS_X509_BADCERT_OTHER: c_ushort = 256;
pub const MBEDTLS_X509_BADCERT_FUTURE: c_ushort = 512;
pub const MBEDTLS_X509_BADCRL_FUTURE: c_ushort = 1024;
pub const MBEDTLS_X509_BADCERT_KEY_USAGE: c_ushort = 2048;
pub const MBEDTLS_X509_BADCERT_EXT_KEY_USAGE: c_ushort = 4096;
pub const MBEDTLS_X509_BADCERT_NS_CERT_TYPE: c_ushort = 8192;
pub const MBEDTLS_X509_BADCERT_BAD_MD: c_ushort = 16384;
pub const MBEDTLS_X509_BADCERT_BAD_PK: c_ushort = 32768;
pub const MBEDTLS_X509_BADCERT_BAD_KEY: c_uint = 65536;
pub const MBEDTLS_X509_BADCRL_BAD_MD: c_uint = 131072;
pub const MBEDTLS_X509_BADCRL_BAD_PK: c_uint = 262144;
pub const MBEDTLS_X509_BADCRL_BAD_KEY: c_uint = 524288;
pub const MBEDTLS_X509_KU_DIGITAL_SIGNATURE: c_uchar = 128;
pub const MBEDTLS_X509_KU_NON_REPUDIATION: c_uchar = 64;
pub const MBEDTLS_X509_KU_KEY_ENCIPHERMENT: c_uchar = 32;
pub const MBEDTLS_X509_KU_DATA_ENCIPHERMENT: c_uchar = 16;
pub const MBEDTLS_X509_KU_KEY_AGREEMENT: c_uchar = 8;
pub const MBEDTLS_X509_KU_KEY_CERT_SIGN: c_uchar = 4;
pub const MBEDTLS_X509_KU_CRL_SIGN: c_uchar = 2;
pub const MBEDTLS_X509_KU_ENCIPHER_ONLY: c_uchar = 1;
pub const MBEDTLS_X509_KU_DECIPHER_ONLY: c_ushort = 32768;
pub const MBEDTLS_X509_NS_CERT_TYPE_SSL_CLIENT: c_uchar = 128;
pub const MBEDTLS_X509_NS_CERT_TYPE_SSL_SERVER: c_uchar = 64;
pub const MBEDTLS_X509_NS_CERT_TYPE_EMAIL: c_uchar = 32;
pub const MBEDTLS_X509_NS_CERT_TYPE_OBJECT_SIGNING: c_uchar = 16;
pub const MBEDTLS_X509_NS_CERT_TYPE_RESERVED: c_uchar = 8;
pub const MBEDTLS_X509_NS_CERT_TYPE_SSL_CA: c_uchar = 4;
pub const MBEDTLS_X509_NS_CERT_TYPE_EMAIL_CA: c_uchar = 2;
pub const MBEDTLS_X509_NS_CERT_TYPE_OBJECT_SIGNING_CA: c_uchar = 1;
pub const MBEDTLS_X509_EXT_AUTHORITY_KEY_IDENTIFIER: c_uchar = 1;
pub const MBEDTLS_X509_EXT_SUBJECT_KEY_IDENTIFIER: c_uchar = 2;
pub const MBEDTLS_X509_EXT_KEY_USAGE: c_uchar = 4;
pub const MBEDTLS_X509_EXT_CERTIFICATE_POLICIES: c_uchar = 8;
pub const MBEDTLS_X509_EXT_POLICY_MAPPINGS: c_uchar = 16;
pub const MBEDTLS_X509_EXT_SUBJECT_ALT_NAME: c_uchar = 32;
pub const MBEDTLS_X509_EXT_ISSUER_ALT_NAME: c_uchar = 64;
pub const MBEDTLS_X509_EXT_SUBJECT_DIRECTORY_ATTRS: c_uchar = 128;
pub const MBEDTLS_X509_EXT_BASIC_CONSTRAINTS: c_ushort = 256;
pub const MBEDTLS_X509_EXT_NAME_CONSTRAINTS: c_ushort = 512;
pub const MBEDTLS_X509_EXT_POLICY_CONSTRAINTS: c_ushort = 1024;
pub const MBEDTLS_X509_EXT_EXTENDED_KEY_USAGE: c_ushort = 2048;
pub const MBEDTLS_X509_EXT_CRL_DISTRIBUTION_POINTS: c_ushort = 4096;
pub const MBEDTLS_X509_EXT_INIHIBIT_ANYPOLICY: c_ushort = 8192;
pub const MBEDTLS_X509_EXT_FRESHEST_CRL: c_ushort = 16384;
pub const MBEDTLS_X509_EXT_NS_CERT_TYPE: c_uint = 65536;
pub const MBEDTLS_X509_FORMAT_DER: c_uchar = 1;
pub const MBEDTLS_X509_FORMAT_PEM: c_uchar = 2;
pub const MBEDTLS_X509_MAX_DN_NAME_SIZE: c_ushort = 256;
pub const MBEDTLS_X509_CRT_VERSION_1: c_uchar = 0;
pub const MBEDTLS_X509_CRT_VERSION_2: c_uchar = 1;
pub const MBEDTLS_X509_CRT_VERSION_3: c_uchar = 2;
pub const MBEDTLS_X509_RFC5280_MAX_SERIAL_LEN: c_uchar = 32;
pub const MBEDTLS_X509_RFC5280_UTC_TIME_LEN: c_uchar = 15;
pub const MBEDTLS_ERR_DHM_BAD_INPUT_DATA: c_short = -12416;
pub const MBEDTLS_ERR_DHM_READ_PARAMS_FAILED: c_short = -12544;
pub const MBEDTLS_ERR_DHM_MAKE_PARAMS_FAILED: c_short = -12672;
pub const MBEDTLS_ERR_DHM_READ_PUBLIC_FAILED: c_short = -12800;
pub const MBEDTLS_ERR_DHM_MAKE_PUBLIC_FAILED: c_short = -12928;
pub const MBEDTLS_ERR_DHM_CALC_SECRET_FAILED: c_short = -13056;
pub const MBEDTLS_ERR_DHM_INVALID_FORMAT: c_short = -13184;
pub const MBEDTLS_ERR_DHM_ALLOC_FAILED: c_short = -13312;
pub const MBEDTLS_ERR_DHM_FILE_IO_ERROR: c_short = -13440;
pub const MBEDTLS_ERR_SSL_FEATURE_UNAVAILABLE: c_short = -28800;
pub const MBEDTLS_ERR_SSL_BAD_INPUT_DATA: c_short = -28928;
pub const MBEDTLS_ERR_SSL_INVALID_MAC: c_short = -29056;
pub const MBEDTLS_ERR_SSL_INVALID_RECORD: c_short = -29184;
pub const MBEDTLS_ERR_SSL_CONN_EOF: c_short = -29312;
pub const MBEDTLS_ERR_SSL_UNKNOWN_CIPHER: c_short = -29440;
pub const MBEDTLS_ERR_SSL_NO_CIPHER_CHOSEN: c_short = -29568;
pub const MBEDTLS_ERR_SSL_NO_RNG: c_short = -29696;
pub const MBEDTLS_ERR_SSL_NO_CLIENT_CERTIFICATE: c_short = -29824;
pub const MBEDTLS_ERR_SSL_CERTIFICATE_TOO_LARGE: c_short = -29952;
pub const MBEDTLS_ERR_SSL_CERTIFICATE_REQUIRED: c_short = -30080;
pub const MBEDTLS_ERR_SSL_PRIVATE_KEY_REQUIRED: c_short = -30208;
pub const MBEDTLS_ERR_SSL_CA_CHAIN_REQUIRED: c_short = -30336;
pub const MBEDTLS_ERR_SSL_UNEXPECTED_MESSAGE: c_short = -30464;
pub const MBEDTLS_ERR_SSL_FATAL_ALERT_MESSAGE: c_short = -30592;
pub const MBEDTLS_ERR_SSL_PEER_VERIFY_FAILED: c_short = -30720;
pub const MBEDTLS_ERR_SSL_PEER_CLOSE_NOTIFY: c_short = -30848;
pub const MBEDTLS_ERR_SSL_BAD_HS_CLIENT_HELLO: c_short = -30976;
pub const MBEDTLS_ERR_SSL_BAD_HS_SERVER_HELLO: c_short = -31104;
pub const MBEDTLS_ERR_SSL_BAD_HS_CERTIFICATE: c_short = -31232;
pub const MBEDTLS_ERR_SSL_BAD_HS_CERTIFICATE_REQUEST: c_short = -31360;
pub const MBEDTLS_ERR_SSL_BAD_HS_SERVER_KEY_EXCHANGE: c_short = -31488;
pub const MBEDTLS_ERR_SSL_BAD_HS_SERVER_HELLO_DONE: c_short = -31616;
pub const MBEDTLS_ERR_SSL_BAD_HS_CLIENT_KEY_EXCHANGE: c_short = -31744;
pub const MBEDTLS_ERR_SSL_BAD_HS_CLIENT_KEY_EXCHANGE_RP: c_short = -31872;
pub const MBEDTLS_ERR_SSL_BAD_HS_CLIENT_KEY_EXCHANGE_CS: c_short = -32000;
pub const MBEDTLS_ERR_SSL_BAD_HS_CERTIFICATE_VERIFY: c_short = -32128;
pub const MBEDTLS_ERR_SSL_BAD_HS_CHANGE_CIPHER_SPEC: c_short = -32256;
pub const MBEDTLS_ERR_SSL_BAD_HS_FINISHED: c_short = -32384;
pub const MBEDTLS_ERR_SSL_ALLOC_FAILED: c_short = -32512;
pub const MBEDTLS_ERR_SSL_HW_ACCEL_FAILED: c_short = -32640;
pub const MBEDTLS_ERR_SSL_HW_ACCEL_FALLTHROUGH: c_short = -28544;
pub const MBEDTLS_ERR_SSL_COMPRESSION_FAILED: c_short = -28416;
pub const MBEDTLS_ERR_SSL_BAD_HS_PROTOCOL_VERSION: c_short = -28288;
pub const MBEDTLS_ERR_SSL_BAD_HS_NEW_SESSION_TICKET: c_short = -28160;
pub const MBEDTLS_ERR_SSL_SESSION_TICKET_EXPIRED: c_short = -28032;
pub const MBEDTLS_ERR_SSL_PK_TYPE_MISMATCH: c_short = -27904;
pub const MBEDTLS_ERR_SSL_UNKNOWN_IDENTITY: c_short = -27776;
pub const MBEDTLS_ERR_SSL_INTERNAL_ERROR: c_short = -27648;
pub const MBEDTLS_ERR_SSL_COUNTER_WRAPPING: c_short = -27520;
pub const MBEDTLS_ERR_SSL_WAITING_SERVER_HELLO_RENEGO: c_short = -27392;
pub const MBEDTLS_ERR_SSL_HELLO_VERIFY_REQUIRED: c_short = -27264;
pub const MBEDTLS_ERR_SSL_BUFFER_TOO_SMALL: c_short = -27136;
pub const MBEDTLS_ERR_SSL_NO_USABLE_CIPHERSUITE: c_short = -27008;
pub const MBEDTLS_ERR_SSL_WANT_READ: c_short = -26880;
pub const MBEDTLS_ERR_SSL_WANT_WRITE: c_short = -26752;
pub const MBEDTLS_ERR_SSL_TIMEOUT: c_short = -26624;
pub const MBEDTLS_ERR_SSL_CLIENT_RECONNECT: c_short = -26496;
pub const MBEDTLS_ERR_SSL_UNEXPECTED_RECORD: c_short = -26368;
pub const MBEDTLS_SSL_MAJOR_VERSION_3: c_uchar = 3;
pub const MBEDTLS_SSL_MINOR_VERSION_0: c_uchar = 0;
pub const MBEDTLS_SSL_MINOR_VERSION_1: c_uchar = 1;
pub const MBEDTLS_SSL_MINOR_VERSION_2: c_uchar = 2;
pub const MBEDTLS_SSL_MINOR_VERSION_3: c_uchar = 3;
pub const MBEDTLS_SSL_TRANSPORT_STREAM: c_uchar = 0;
pub const MBEDTLS_SSL_TRANSPORT_DATAGRAM: c_uchar = 1;
pub const MBEDTLS_SSL_MAX_HOST_NAME_LEN: c_uchar = 255;
pub const MBEDTLS_SSL_MAX_FRAG_LEN_NONE: c_uchar = 0;
pub const MBEDTLS_SSL_MAX_FRAG_LEN_512: c_uchar = 1;
pub const MBEDTLS_SSL_MAX_FRAG_LEN_1024: c_uchar = 2;
pub const MBEDTLS_SSL_MAX_FRAG_LEN_2048: c_uchar = 3;
pub const MBEDTLS_SSL_MAX_FRAG_LEN_4096: c_uchar = 4;
pub const MBEDTLS_SSL_MAX_FRAG_LEN_INVALID: c_uchar = 5;
pub const MBEDTLS_SSL_IS_CLIENT: c_uchar = 0;
pub const MBEDTLS_SSL_IS_SERVER: c_uchar = 1;
pub const MBEDTLS_SSL_IS_NOT_FALLBACK: c_uchar = 0;
pub const MBEDTLS_SSL_IS_FALLBACK: c_uchar = 1;
pub const MBEDTLS_SSL_EXTENDED_MS_DISABLED: c_uchar = 0;
pub const MBEDTLS_SSL_EXTENDED_MS_ENABLED: c_uchar = 1;
pub const MBEDTLS_SSL_ETM_DISABLED: c_uchar = 0;
pub const MBEDTLS_SSL_ETM_ENABLED: c_uchar = 1;
pub const MBEDTLS_SSL_COMPRESS_NULL: c_uchar = 0;
pub const MBEDTLS_SSL_COMPRESS_DEFLATE: c_uchar = 1;
pub const MBEDTLS_SSL_VERIFY_NONE: c_uchar = 0;
pub const MBEDTLS_SSL_VERIFY_OPTIONAL: c_uchar = 1;
pub const MBEDTLS_SSL_VERIFY_REQUIRED: c_uchar = 2;
pub const MBEDTLS_SSL_VERIFY_UNSET: c_uchar = 3;
pub const MBEDTLS_SSL_LEGACY_RENEGOTIATION: c_uchar = 0;
pub const MBEDTLS_SSL_SECURE_RENEGOTIATION: c_uchar = 1;
pub const MBEDTLS_SSL_RENEGOTIATION_DISABLED: c_uchar = 0;
pub const MBEDTLS_SSL_RENEGOTIATION_ENABLED: c_uchar = 1;
pub const MBEDTLS_SSL_ANTI_REPLAY_DISABLED: c_uchar = 0;
pub const MBEDTLS_SSL_ANTI_REPLAY_ENABLED: c_uchar = 1;
pub const MBEDTLS_SSL_RENEGOTIATION_NOT_ENFORCED: c_char = -1;
pub const MBEDTLS_SSL_RENEGO_MAX_RECORDS_DEFAULT: c_uchar = 16;
pub const MBEDTLS_SSL_LEGACY_NO_RENEGOTIATION: c_uchar = 0;
pub const MBEDTLS_SSL_LEGACY_ALLOW_RENEGOTIATION: c_uchar = 1;
pub const MBEDTLS_SSL_LEGACY_BREAK_HANDSHAKE: c_uchar = 2;
pub const MBEDTLS_SSL_TRUNC_HMAC_DISABLED: c_uchar = 0;
pub const MBEDTLS_SSL_TRUNC_HMAC_ENABLED: c_uchar = 1;
pub const MBEDTLS_SSL_TRUNCATED_HMAC_LEN: c_uchar = 10;
pub const MBEDTLS_SSL_SESSION_TICKETS_DISABLED: c_uchar = 0;
pub const MBEDTLS_SSL_SESSION_TICKETS_ENABLED: c_uchar = 1;
pub const MBEDTLS_SSL_CBC_RECORD_SPLITTING_DISABLED: c_uchar = 0;
pub const MBEDTLS_SSL_CBC_RECORD_SPLITTING_ENABLED: c_uchar = 1;
pub const MBEDTLS_SSL_ARC4_ENABLED: c_uchar = 0;
pub const MBEDTLS_SSL_ARC4_DISABLED: c_uchar = 1;
pub const MBEDTLS_SSL_PRESET_DEFAULT: c_uchar = 0;
pub const MBEDTLS_SSL_PRESET_SUITEB: c_uchar = 2;
pub const MBEDTLS_SSL_DTLS_TIMEOUT_DFL_MIN: c_ushort = 1000;
pub const MBEDTLS_SSL_DTLS_TIMEOUT_DFL_MAX: c_ushort = 60000;
pub const MBEDTLS_SSL_DEFAULT_TICKET_LIFETIME: c_uint = 86400;
pub const MBEDTLS_SSL_MAX_CONTENT_LEN: c_ushort = 16384;
pub const MBEDTLS_SSL_VERIFY_DATA_MAX_LEN: c_uchar = 12;
pub const MBEDTLS_SSL_EMPTY_RENEGOTIATION_INFO: c_uchar = 255;
pub const MBEDTLS_SSL_FALLBACK_SCSV_VALUE: c_ushort = 22016;
pub const MBEDTLS_SSL_HASH_NONE: c_uchar = 0;
pub const MBEDTLS_SSL_HASH_MD5: c_uchar = 1;
pub const MBEDTLS_SSL_HASH_SHA1: c_uchar = 2;
pub const MBEDTLS_SSL_HASH_SHA224: c_uchar = 3;
pub const MBEDTLS_SSL_HASH_SHA256: c_uchar = 4;
pub const MBEDTLS_SSL_HASH_SHA384: c_uchar = 5;
pub const MBEDTLS_SSL_HASH_SHA512: c_uchar = 6;
pub const MBEDTLS_SSL_SIG_ANON: c_uchar = 0;
pub const MBEDTLS_SSL_SIG_RSA: c_uchar = 1;
pub const MBEDTLS_SSL_SIG_ECDSA: c_uchar = 3;
pub const MBEDTLS_SSL_CERT_TYPE_RSA_SIGN: c_uchar = 1;
pub const MBEDTLS_SSL_CERT_TYPE_ECDSA_SIGN: c_uchar = 64;
pub const MBEDTLS_SSL_MSG_CHANGE_CIPHER_SPEC: c_uchar = 20;
pub const MBEDTLS_SSL_MSG_ALERT: c_uchar = 21;
pub const MBEDTLS_SSL_MSG_HANDSHAKE: c_uchar = 22;
pub const MBEDTLS_SSL_MSG_APPLICATION_DATA: c_uchar = 23;
pub const MBEDTLS_SSL_ALERT_LEVEL_WARNING: c_uchar = 1;
pub const MBEDTLS_SSL_ALERT_LEVEL_FATAL: c_uchar = 2;
pub const MBEDTLS_SSL_ALERT_MSG_CLOSE_NOTIFY: c_uchar = 0;
pub const MBEDTLS_SSL_ALERT_MSG_UNEXPECTED_MESSAGE: c_uchar = 10;
pub const MBEDTLS_SSL_ALERT_MSG_BAD_RECORD_MAC: c_uchar = 20;
pub const MBEDTLS_SSL_ALERT_MSG_DECRYPTION_FAILED: c_uchar = 21;
pub const MBEDTLS_SSL_ALERT_MSG_RECORD_OVERFLOW: c_uchar = 22;
pub const MBEDTLS_SSL_ALERT_MSG_DECOMPRESSION_FAILURE: c_uchar = 30;
pub const MBEDTLS_SSL_ALERT_MSG_HANDSHAKE_FAILURE: c_uchar = 40;
pub const MBEDTLS_SSL_ALERT_MSG_NO_CERT: c_uchar = 41;
pub const MBEDTLS_SSL_ALERT_MSG_BAD_CERT: c_uchar = 42;
pub const MBEDTLS_SSL_ALERT_MSG_UNSUPPORTED_CERT: c_uchar = 43;
pub const MBEDTLS_SSL_ALERT_MSG_CERT_REVOKED: c_uchar = 44;
pub const MBEDTLS_SSL_ALERT_MSG_CERT_EXPIRED: c_uchar = 45;
pub const MBEDTLS_SSL_ALERT_MSG_CERT_UNKNOWN: c_uchar = 46;
pub const MBEDTLS_SSL_ALERT_MSG_ILLEGAL_PARAMETER: c_uchar = 47;
pub const MBEDTLS_SSL_ALERT_MSG_UNKNOWN_CA: c_uchar = 48;
pub const MBEDTLS_SSL_ALERT_MSG_ACCESS_DENIED: c_uchar = 49;
pub const MBEDTLS_SSL_ALERT_MSG_DECODE_ERROR: c_uchar = 50;
pub const MBEDTLS_SSL_ALERT_MSG_DECRYPT_ERROR: c_uchar = 51;
pub const MBEDTLS_SSL_ALERT_MSG_EXPORT_RESTRICTION: c_uchar = 60;
pub const MBEDTLS_SSL_ALERT_MSG_PROTOCOL_VERSION: c_uchar = 70;
pub const MBEDTLS_SSL_ALERT_MSG_INSUFFICIENT_SECURITY: c_uchar = 71;
pub const MBEDTLS_SSL_ALERT_MSG_INTERNAL_ERROR: c_uchar = 80;
pub const MBEDTLS_SSL_ALERT_MSG_INAPROPRIATE_FALLBACK: c_uchar = 86;
pub const MBEDTLS_SSL_ALERT_MSG_USER_CANCELED: c_uchar = 90;
pub const MBEDTLS_SSL_ALERT_MSG_NO_RENEGOTIATION: c_uchar = 100;
pub const MBEDTLS_SSL_ALERT_MSG_UNSUPPORTED_EXT: c_uchar = 110;
pub const MBEDTLS_SSL_ALERT_MSG_UNRECOGNIZED_NAME: c_uchar = 112;
pub const MBEDTLS_SSL_ALERT_MSG_UNKNOWN_PSK_IDENTITY: c_uchar = 115;
pub const MBEDTLS_SSL_ALERT_MSG_NO_APPLICATION_PROTOCOL: c_uchar = 120;
pub const MBEDTLS_SSL_HS_HELLO_REQUEST: c_uchar = 0;
pub const MBEDTLS_SSL_HS_CLIENT_HELLO: c_uchar = 1;
pub const MBEDTLS_SSL_HS_SERVER_HELLO: c_uchar = 2;
pub const MBEDTLS_SSL_HS_HELLO_VERIFY_REQUEST: c_uchar = 3;
pub const MBEDTLS_SSL_HS_NEW_SESSION_TICKET: c_uchar = 4;
pub const MBEDTLS_SSL_HS_CERTIFICATE: c_uchar = 11;
pub const MBEDTLS_SSL_HS_SERVER_KEY_EXCHANGE: c_uchar = 12;
pub const MBEDTLS_SSL_HS_CERTIFICATE_REQUEST: c_uchar = 13;
pub const MBEDTLS_SSL_HS_SERVER_HELLO_DONE: c_uchar = 14;
pub const MBEDTLS_SSL_HS_CERTIFICATE_VERIFY: c_uchar = 15;
pub const MBEDTLS_SSL_HS_CLIENT_KEY_EXCHANGE: c_uchar = 16;
pub const MBEDTLS_SSL_HS_FINISHED: c_uchar = 20;
pub const MBEDTLS_TLS_EXT_SERVERNAME: c_uchar = 0;
pub const MBEDTLS_TLS_EXT_SERVERNAME_HOSTNAME: c_uchar = 0;
pub const MBEDTLS_TLS_EXT_MAX_FRAGMENT_LENGTH: c_uchar = 1;
pub const MBEDTLS_TLS_EXT_TRUNCATED_HMAC: c_uchar = 4;
pub const MBEDTLS_TLS_EXT_SUPPORTED_ELLIPTIC_CURVES: c_uchar = 10;
pub const MBEDTLS_TLS_EXT_SUPPORTED_POINT_FORMATS: c_uchar = 11;
pub const MBEDTLS_TLS_EXT_SIG_ALG: c_uchar = 13;
pub const MBEDTLS_TLS_EXT_ALPN: c_uchar = 16;
pub const MBEDTLS_TLS_EXT_ENCRYPT_THEN_MAC: c_uchar = 22;
pub const MBEDTLS_TLS_EXT_EXTENDED_MASTER_SECRET: c_uchar = 23;
pub const MBEDTLS_TLS_EXT_SESSION_TICKET: c_uchar = 35;
pub const MBEDTLS_TLS_EXT_ECJPAKE_KKPP: c_ushort = 256;
pub const MBEDTLS_TLS_EXT_RENEGOTIATION_INFO: c_ushort = 65281;
