...
postprocess_after_rustfmt()
{
	...
	# 2 - Make MBEDTLS_SSL_ARC4_DISABLED & MBEDTLS_SSL_ARC4_ENABLED c_char
	# 2 - Make MBEDTLS_SSL_CBC_RECORD_SPLITTING_DISABLED & MBEDTLS_SSL_CBC_RECORD_SPLITTING_ENABLED c_char
	sed \
		...
		-e 's/MBEDTLS_SSL_ARC4_DISABLED: c_int/MBEDTLS_SSL_ARC4_DISABLED: c_char/g' -e 's/MBEDTLS_SSL_ARC4_ENABLED: c_int/MBEDTLS_SSL_ARC4_ENABLED: c_char/g' \
		-e 's/MBEDTLS_SSL_CBC_RECORD_SPLITTING_DISABLED: c_int/MBEDTLS_SSL_CBC_RECORD_SPLITTING_DISABLED: c_char/g' -e 's/MBEDTLS_SSL_CBC_RECORD_SPLITTING_ENABLED: c_int/MBEDTLS_SSL_CBC_RECORD_SPLITTING_ENABLED: c_char/g'
}
